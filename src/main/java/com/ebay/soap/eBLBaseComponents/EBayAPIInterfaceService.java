 ...
 * 
 */
@WebServiceClient(name = "eBayAPIInterfaceService", targetNamespace = "urn:ebay:apis:eBLBaseComponents", wsdlLocation = "file:/Users/nachocodev/Downloads/ebay-java-sdk-master/src/main/resources/eBaySvc.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            ...
            url = new URL(baseUrl, "file:/Users/nachocodev/Downloads/ebay-java-sdk-master/src/main/resources/eBaySvc.wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'file:/Users/nachocodev/Downloads/ebay-java-sdk-master/src/main/resources/eBaySvc.wsdl', retrying as a local file");
